...
/*!< bypass Block bypass for HW use*/
    ...
    /*!< bypass_compression bypass for the (de)companding*/
...
/*! \struct af_awb_frstatistics_2_0
...
/*!< enable Block enable for HW use*/
    int32_t enable;
    /*!< x_center Width center of frame. Bittage is enough to fit 16K resolution*/
    int32_t x_center;
    /*!< y_center Height center of frame. Bittage is enough to fit 16K resolution*/
    int32_t y_center;
    /*!< x_start x cordinate of the processed stripe. Bittage is enough for supporting 8192x4320 resulotion*/
    int32_t x_start;
    /*!< y_start y cordinate of the processed stripe. Bittage is enough for supporting 8192x4320 resulotion*/
    int32_t y_start;
    ...
    /*!< nm_lut[16] noise model for luma*/
    int32_t nm_lut[16];
    ...
    /*!< skin_feature_enable enables skin suppressing sharpening feature*/
    int32_t skin_feature_enable;
...
typedef struct
{
/*!< bypass Chroma MF switch: 0 - enable , 1 - disable*/
    int32_t bypass;
    /*!< blend_power Blending power*/
    int32_t blend_power;

} ia_pal_isp_cmf_1_0_t;
...
/*!< bypass Bypass filter*/
    ...
    /*!< gtm_enable Enable GTM functionality*/
    int32_t gtm_enable;
    /*!< gtm_scale Control image brightness by changing GTM curve*/
    int32_t gtm_scale;
    /*!< gtm_max_percentile Valid signal range for GTM max*/
    int32_t gtm_max_percentile;
    /*!< gtm_min_percentile Valid signal range for GTM min*/
    int32_t gtm_min_percentile;
    /*!< gtm_gamma Apply gamma on top of GTM curve*/
    int32_t gtm_gamma;
    /*!< gtm_vmax_limit Offset for GTM max*/
    int32_t gtm_vmax_limit;
    /*!< gtm_conv_sigma Control weight in GTM max temporal filtering*/
    int32_t gtm_conv_sigma;
    /*!< gtm_conv_coef Control coefficient in temporal filtering*/
    int32_t gtm_conv_coef;
    /*!< gtm_conv_coef_slow Control slow GTM temporal filtering*/
    int32_t gtm_conv_coef_slow;
    /*!< ev_shift Exposure value shift*/
    int32_t ev_shift;
    /*!< sharpness_max Control how much sharpened image in LTM simulation*/
    int32_t sharpness_max;
    /*!< gce_enable Enable GCE functionality*/
    int32_t gce_enable;
    /*!< gce_conv_coef Control coefficient in GCE temporal filtering*/
    int32_t gce_conv_coef;
    /*!< gce_weight Control GCE blending weight of referenc eand accumulated histograms*/
    int32_t gce_weight;
    /*!< gce_scale Scale applied to metric calculated from HDR stat*/
    int32_t gce_scale;
    /*!< ltm_enable ltm enable*/
    int32_t ltm_enable;
    /*!< ltm_weight ltm weight*/
...
/*!< filter_size filter size. {4-BCI, 6-Lancos}*/
    ...
    /*!< grid_x_lut[441] Grid X LUT (S14.8)*/
    int32_t grid_x_lut[441];
    /*!< grid_y_lut[441] Grid Y LUT (S14.8)*/
    int32_t grid_y_lut[441];
    /*!< grid_z_lut[441] Grid Z LUT (S14.8)*/
    int32_t grid_z_lut[441];
    /*!< grid_horizontal_offset[20] Horizontal Offset Grid*/
    int32_t grid_horizontal_offset[20];
    /*!< grid_vertical_offset[20] Vertical Offset Grid*/
    int32_t grid_vertical_offset[20];
...
/*! \struct gdc7
Geometric Distortion Correction Full Res
*/
typedef struct
{
/*!< filter_size filter size. {4-BCI, 6-Lancos}*/
...
} ia_pal_isp_input_feeder_t;

/*! \struct input_system_drainer
...
/*! \struct ltm_de_1_0
Local Tone Maping Detail Enhancement
*/
typedef struct
{
/*!< enable enabling the block. If enable == false, Output = Input*/
    int32_t enable;
    /*!< ltm_de_lut_base_level[7] base level for  tone mapping lut*/
    int32_t ltm_de_lut_base_level[7];
    /*!< ltm_de_lut_start_bin[7] start bin for  tone mapping lut*/
    int32_t ltm_de_lut_start_bin[7];
    /*!< ltm_de_lut_size tone mapping lut size*/
    int32_t ltm_de_lut_size;
    /*!< ltm_de_lut_gen_lut[2049] generalized lut for tone mapping lut*/
    int32_t ltm_de_lut_gen_lut[2049];
    ...
    /*!< linear_pdestal Pedestal subtracted in linear domain*/
    int32_t linear_pdestal;
    /*!< ltm_de_lut_step[7] step size for generalized LUT*/
    int32_t ltm_de_lut_step[7];
    /*!< enable_ltm enabling the ltm*/
    int32_t enable_ltm;

} ia_pal_isp_ltm_de_1_0_t;
...
} ia_pal_isp_output_drainer_t;

/*! \struct packer_isa_bayer_a
...
/*! \struct packer_isa_yuv_a
NV12 output formatter
*/
typedef struct
{
/*!< format Output format: 0 - YUV planar, 1 - NV12*/
    int32_t format;

} ia_pal_isp_packer_isa_yuv_a_t;

/*! \struct packer_isa_yuv_b
NV12 output formatter
*/
typedef struct
{
...
/*! \struct pixprecadapter_post_sis
...
/*!< enable enable scaling filter*/
    int32_t enable;
    /*!< scaler_sel 0-bypass. 1-downscale. 2-upscale*/
    int32_t scaler_sel;
    /*!< scaling_ratio Scaling factor, 16bit fixed point, downscale - greater than 1, upscale - less than 1*/
    int32_t scaling_ratio;
    /*!< block_width Horizontal size of input block*/
    int32_t block_width;
    /*!< block_height Vertical size of input block*/
    int32_t block_height;
    /*!< output_height Height of output image Y plane for scaler*/
    int32_t output_height;
    /*!< output_width Width of output image Y plane for scaler*/
    int32_t output_width;
    /*!< kernel_LUT[129] Interpolation vertical kernel coefficients for scaler*/
    int32_t kernel_LUT[129];
    /*!< input_height Height of input image Y plane*/
    int32_t input_height;

} ia_pal_isp_sc_outputscaler_2_0_t;
...
/*! \struct sc_outputscaler_ppp_1_1
...
/*! \struct tnr7_blend_cv_1_0

*/
typedef struct
{
/*!< enable Enable TNR7 blend CV*/
    int32_t enable;
    /*!< max_recursive_similarity Maximum value of recursive similarity*/
    int32_t max_recursive_similarity;
    /*!< w_out_prev_LUT[32] Weight of reference in the main output*/
...
} ia_pal_isp_tnr7_blend_cv_1_0_t;
...
/*!< enable Enable TNR7 CME (Course Motion Estimation)*/
    int32_t enable;
    /*!< search_range_x Integer Search Displacement X*/
    uint32_t search_range_x;
    /*!< search_range_y Integer Search Displacement Y*/
    ...
    uint32_t noise_apu_min;
    /*!< noise_apu_alpha_limit Noise APU Alpha Limit*/
    uint32_t noise_apu_alpha_limit;
    /*!< noise_apu_alpha_power Noise APU Alpha Power*/
    uint32_t noise_apu_alpha_power;
    /*!< predictor_enable Parametric Predictor Enable*/
    int32_t predictor_enable;
    /*!< model_valid Model Valid*/
    int32_t model_valid;
    /*!< model_confidence Overall Model Confidence*/
    int32_t model_confidence;
    /*!< model_ax0 Model X Component Shift*/
    int32_t model_ax0;
    /*!< model_ay0 Model Y Component Shift*/
    int32_t model_ay0;
    /*!< model_ax1 Model X Component Scale*/
    int32_t model_ax1;
    /*!< model_ay1 Model Y Component Scale*/
    int32_t model_ay1;
    /*!< noise_estimator_level_valid Noise Estimator Level*/
    int32_t noise_estimator_level_valid;
    /*!< noise_estimator_level Noise Estimator Level*/
    uint32_t noise_estimator_level;
...
typedef struct
{
/*!< enable Enable TNR7 motion compensation*/
    int32_t enable;
...
typedef struct
{
/*!< rme_enable Enable TNR7 RME*/
    int32_t rme_enable;
    /*!< rme4_median_enable Enable TNR7 RME*/
    int32_t rme4_median_enable;
    /*!< rme16_median_enable Enable TNR7 RME*/
    ...
    /*!< rme16_n_iterations Number of update iterations for each window location of the rme4 run. 0 = bypass update stage.*/
    int32_t rme16_n_iterations;
    /*!< rme4_n_iterations Number of update iterations for each window location of the rme16 run. 0 = bypass update stage.*/
    ...
    /*!< rme16_sv2inv_man_int Motion regulation parameter for rme16: sv2inv = sv2inv_man * 2^sv2inv_exp*/
    int32_t rme16_sv2inv_man_int;
    /*!< rme4_sv2inv_man_int Motion regulation parameter for rme4: sv2inv = sv2inv_man * 2^sv2inv_exp*/
    int32_t rme4_sv2inv_man_int;
    /*!< rme16_sv2inv_exp Motion regulation parameter for rme16: sv2inv = sv2inv_man * 2^sv2inv_exp*/
    int32_t rme16_sv2inv_exp;
    /*!< rme4_sv2inv_exp Motion regulation parameter for rme4: sv2inv = sv2inv_man * 2^sv2inv_exp*/
    int32_t rme4_sv2inv_exp;

} ia_pal_isp_tnr7_rme_1_0_t;

/*! \struct tnr7_spatial_1_0
...
/*!< bypass Bypass TVS*/
    ...
    /*!< ds_factor_hor_frac Fractional part of downscale factor in horizontal*/
    int32_t ds_factor_hor_frac;
    /*!< ds_factor_ver_int Integer part of downscale factor in vertical*/
    int32_t ds_factor_ver_int;
    /*!< ds_factor_ver_frac Fractional part of downscale factor in vertical*/
    int32_t ds_factor_ver_frac;
    /*!< crop_col_start Input cropping starting column*/
    int32_t crop_col_start;
    /*!< crop_row_start Input cropping starting row*/
    int32_t crop_row_start;
    /*!< crop_width Input cropping width*/
    int32_t crop_width;
    /*!< crop_height Input cropping height*/
    int32_t crop_height;
    ...
    /*!< conv_point_kernels[396] Conv layer pointwise kernel weights*/
    int32_t conv_point_kernels[396];
    /*!< conv_point_kernels_shift Conv layer pointwise kernels fixed point value shift*/
    int32_t conv_point_kernels_shift;
    /*!< conv_biases[33] Conv layer bias weights*/
    int32_t conv_biases[33];
    ...
    /*!< cu_act_func_y[15] Activation function ConfigUnit y vector*/
    int32_t cu_act_func_y[15];
    /*!< cu_act_func_slope[15] Activation function ConfigUnit slope vector*/
    int32_t cu_act_func_slope[15];
    /*!< act_func_output_offset Offset after Activation function*/
    int32_t act_func_output_offset;
    /*!< avg_weights[33] Avg layer weights*/
    int32_t avg_weights[33];
    ...
    /*!< avg_data_shift Weighted averaging fixed point value shift*/
    int32_t avg_data_shift;
    /*!< output_format_420 Outpu data format (0: YUV444; 1: YUV420)*/
