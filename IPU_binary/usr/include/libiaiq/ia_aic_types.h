...
struct IaAicBuffer
{
    ...
    long sequence;           /*! Frame sequence the buffer has been previously associated with
...
struct ImagingKernelInfo
{
    ...
    ImagingKernelFormatInfo formatInfo;            /*!< Kernel input and output format */
...
using IaCcatStatistics = ia_ccat_frame_statistics;
