...
public: /*  methods */
    ...
    *                          is not initialized
    */
    css_err_t getMbrData(int32_t *data, size_t elementCount);
...
private:
    ...
    /* tries to find exec ctx id or stream id from given node */
    css_err_t getExecCtxId(const IGraphConfig *node, int32_t &retId);
