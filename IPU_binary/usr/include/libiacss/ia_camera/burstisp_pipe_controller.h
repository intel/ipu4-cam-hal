...
#ifndef IA_CAMERA_PROCESSING_PIPELINE_BURSTISP_PIPE_CONTROLLER_H_
#define IA_CAMERA_PROCESSING_PIPELINE_BURSTISP_PIPE_CONTROLLER_H_
...
class BurstIspPipeController : public IImagingPipeController {
public:
    BurstIspPipeController();
    virtual ~BurstIspPipeController() {}
...
#endif /* IA_CAMERA_PROCESSING_PIPELINE_BURSTISP_PIPE_CONTROLLER_H_ */
