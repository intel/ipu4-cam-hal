...
enum  {
    ...
    /* roughly measure the time for starting preview */
    CAMERA_DEBUG_LOG_DEVICE_START = 1 << 24
};
...
#define LOGDEVSTART(format, args...) Log::print_log( \
	gLogLevel & CAMERA_DEBUG_LOG_DEVICE_START, \
	LOG_TAG, CAMERA_DEBUG_LOG_DEVICE_START, format, ##args)
