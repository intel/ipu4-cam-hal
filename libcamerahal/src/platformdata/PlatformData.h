...
public:
    ...
    public:
        ...
        public:
            ...
            unsigned int mTopBottomReverse;
...
public:
    ...
    /**
     * Check if requests are triggered by statistics or not
     *
     * \param cameraId: 0 ~ MAX_CAMERA_NUMBER
     * \return true if triggered by statistics.
     */
    static bool isStatsTriggered(int cameraId);
     ...
     */
    static unsigned int getTopBottomReverse(int cameraId);
    /**
     ...
     *
     * \param cameraId: 0 ~ MAX_CAMERA_NUMBER
     * \return metadata size of the camera.
     */
    static unsigned int getMetadataSize(int cameraId);
};
